...
function CalendarSkeleton({ cellSize = 12, cellGap = 3, className }: { cellSize?: number; cellGap?: number; className?: string }) {
    ...
    const days = 7
    return (
        <div className={cn("w-full mx-auto animate-pulse", className)}>
...
export const GithubCalendar = memo(function GithubCalendar({
    ...
    return (
        <TooltipProvider delayDuration={0}>
            ...
            <div className="w-fit mx-auto max-w-full flex flex-col">
                <div
                    ref={scrollRef}
                ...
                >
                    ...
                    <Tooltip open={tooltip.visible}>
                        ...
                        >
                            <div className="font-medium text-[11px] leading-none mb-1">
                                {tooltip.label
                                    ? tooltip.label
                            ...
                            <div className="text-muted text-[10px] leading-none">{tooltip.date}</div>
                        </TooltipContent>
                    </Tooltip>
                </div>
